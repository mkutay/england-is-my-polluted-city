...
public class DataLoader {
    ...
    public DataSet loadDataFile(String fileName) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            ...
            // Discard the next two lines. the first is empty, and the next holds the column labels for the data points.
            br.readLine();
            br.readLine();
     ...
     */
    private String readDataHeader(BufferedReader br) throws java.io.IOException {
        String line = br.readLine();
        String[] values = line.split(COMMA_DELIMITER);
        return values[0];
    }
